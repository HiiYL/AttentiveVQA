...
class CocoDataset(data.Dataset):
    ...
    def __init__(self, mode, question_vocab, ans_vocab, finetune=False,transform=None, max_tokens=10):
    ...
    def __getitem__(self, index):
        ...
        tokens = list(ans)#nltk.tokenize.word_tokenize(str(ans).lower())
        ans = []
...
def collate_fn_vqa(data):
    ...
    return images, targets, lengths, ann_id, ans_targets, ans_lengths
